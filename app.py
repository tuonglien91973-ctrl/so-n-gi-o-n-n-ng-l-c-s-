...
<div class="main-header">
    ...
    <p>Tác giả: Tưởng Thị Liên - Trường Tiểu học Hùng An- ĐT: 0383280500</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Tưởng Thị Liên - Trường Tiểu học Hùng An- ĐT: 0383280500/div>", unsafe_allow_html=True)
